...
// ============================================================
    ...
    function renderUpfrontPivotTable() {
      ...
      if (!data) { document.getElementById('upfrontPivotHeaderRow').innerHTML = `<th style="text-align: left; min-width: 260px;">부서 / 광고주(업프론트용) / 대행사</th><th style="text-align: left;">업프론트 계약금액</th><th style="text-align: center;">계약시작일</th><th style="text-align: center;">계약종료일</th>`; tbody.innerHTML = `<tr><td colspan="4" style="text-align:center; padding: 40px; color: var(--text-secondary);">연도를 1개만 선택하면 표시됩니다.</td></tr>`; document.getElementById('upfrontPivotTotalAmount').innerText = `0 억원`; return; }
