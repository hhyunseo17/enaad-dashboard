...
// ============================================================
    ...
    function renderAdvBucketChart() {
      ...
      chartInstances.advBucket = new Chart(ctx, {
        ...
        }, { type: 'line', label: '합산 매출액', data: sumVals, borderColor: CH('#FFB547'), backgroundColor: ddAreaFill(CH('#FFB547')), fill: true, tension: 0.35, borderWidth: 2.5, pointRadius: 3, pointBackgroundColor: CH('#FFB547'), pointBorderWidth: 0, yAxisID: 'y1', order: 1,
          datalabels: { display: 'auto', anchor: 'end', align: 'top', offset: 8, color: CH('#FFB547'), font: { family: 'Pretendard', size: 11, weight: '400' }, formatter: (v) => v > 0 ? v.toFixed(1) + '억' : '' }
        } ] },
