                ...
                if(isL3Exp) {
                  ...
                  l4Keys.forEach(l4 => {
                    ...
                    if(isL4Exp) {
                      ...
                      l5Keys.forEach(l5 => { html += `<tr><td class="indent-step-5" style="background:#090C10; color:#475569; font-size:13px;">${l5}</td>${genCells(tree[l1].subs[l2].subs[l3].subs[l4].subs[l5], '400')}</tr>`; });
                    }
                  });
                }
              });
