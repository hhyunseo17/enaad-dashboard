...
// ============================================================
    ...
    //   IMC       보라(270°)   HIG 값에서 유일하게 벗어난 자리다.
    //                          Indigo(#5856D6, 241°)는 파랑에 너무 가깝고 채도가 낮아 탁했고,
    //                          Purple(#AF52DE, 280°)은 마젠타로 20° 치우쳐 흰 배경에서 핑크로
    //                          읽혔다. 둘 사이가 HIG에 없어 순수 보라 270°로 잡았다.
    //                          IMC는 항상 일반광고(211°) 위에 쌓이므로 분리가 이 자리의 기준이다.
    //   인포머셜  System Green
    //   큐톤광고  System Orange
