...
// ============================================================
    ...
    const SERIES_ROLES = {
      ...
      // 밑동 기준으로 참조 4.51 < 전월 7.23 < 당월 7.49, 참조↔전월 1.60으로 잡았다.
      //
      ...
      ref:       { light: '#CACED3', dark: '#536781' },  // 목표 · 전년동월 · MoM 전월
      prev:      { light: '#89929F', dark: '#798BA2' },  // 대행사 전월
      ...
      momFlat:   { light: '#969DA6', dark: '#798BA2' },
