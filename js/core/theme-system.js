...
// ============================================================
    ...
    const SERIES_ROLES = {
      ...
      // 밑동 기준으로 참조 6.46 · 전월 9.08 · 참조↔전월 1.40.
      ...
      ref:       { light: '#CACED3', dark: '#68809F' },  // 목표 · 전년동월 · MoM 전월
      prev:      { light: '#89929F', dark: '#8E9DB1' },  // 대행사 전월
      curr:      { light: '#47A0FF', dark: '#2E93FF' },  // 당월 · 비교 차트의 주인공
    ...
    // 직접 적어 다른 막대와 같은 밝기대에 놓는다. 더 올리면 보라가 l83까지 가 물이 빠진다.
    const DUO_FILL_DARK  = ['#4DA3FF', '#C194EE'];
    function ddDuoPair() {
