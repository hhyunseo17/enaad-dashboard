...
// ============================================================
    ...
    //
    // 단계 간격은 인접 대비 1.6:1 이상이 되도록 잡았다(첫 시도는 1.35였고 스택에서 두 층이 붙어 보였다).
    // 앵커인 일반광고를 L38까지 내려 위쪽 여유를 벌었다 — 위로는 못 늘린다. 큐톤광고가 이미
    // 흰 카드 대비 1.40:1이라 더 밝히면 카드에 묻힌다.
    const CAT_MONO_LIGHT = { '일반광고': '#004EC2', 'IMC': '#267CED', '인포머셜': '#83AFE2', '큐톤광고': '#CFDBE8', '기타광고': '#94989E' };
    const CAT_MONO_DARK  = { '일반광고': '#0A6CFF', 'IMC': '#5198F6', '인포머셜': '#99BFEA', '큐톤광고': '#D5E0EC', '기타광고': '#8A8E93' };
