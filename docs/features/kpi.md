...
## 규칙/주의
- 총매출/전년동기/광고주당/신규광고주 카드는 filteredData(applyFilters() 적용) 기준. 목표 대비 달성률(KPI+차트)만 예외적으로 본부매출+실적+연월 스코프 고정 집계(좌측 체크박스 필터 미반영).
- 클릭 연결: 광고주당매출→bucket, 신규광고주→newAdvPivot, 업프론트→upfrontPivot. 목표 대비 달성률 카드는 클릭 연결 없음.
- 금액: 억원.
